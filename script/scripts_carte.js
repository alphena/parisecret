...
//	Y'a 2 'categories' de lieux pour tester, c'est 'lieu' et 'random'
			...
			var endroits = [
				...
				['Le cinéma des Cinéastes',48.8842982,2.3246695,'cinema','Ce bâtiment a toujours fait partie de la vie sociale nocturne parisiennes. Dès 1765, le Père Lathuile y ouvre un cabaret qui aurait été immortalisé dans l\'une des toiles de Manet. Puis en 1906, il est transformé en café-concert où de nombreux artistes se produiront. Le cinéma s\'en empare ensuite dans les années 30. Aujourd\'hui c\'est une façade rénovée, rouge et très moderne qui vous accueille. Avant le début du film, ne manquez pas de visiter le hall où des objets liés au monde du cinéma sont exposés. Il faut également penser à admirer la gracieuse structure métallique de la salle 1 qui date de l\'époque d\'Eiffel.','images/cineastes.jpg','7 avenue de Clichy - 17e arr.','Place de Clichy - lignes 2 et 16'],
