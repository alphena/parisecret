...
//	Y'a 2 'categories' de lieux pour tester, c'est 'lieu' et 'random'
			...
			var endroits = [
				['Les potelets CyKlop',48.8837477,2.3357739,'art','Les premiers potelets apparaissent à Paris au Xvème siècle et leur fonction était alors de familiariser les élèves des écoles équine avec la monte. Sous Napoléon Bonaparte la forme particulière du potelet permettait aux agents de police d\'y menotter un prévenu en attendant le passage du fourgon. Aujourd\'hui, rebaptisés poétiquement « borne anti-stationnement » ils ont pour fonction d\'empêcher les véhicules d\'occuper les trottoirs. Mais depuis 2007, peut-être parce qu\'il trouvait ces mobiliers urbains très laids l\'artiste graffeur français Le CyKlop à commencer à leur donner un chacun … un œil de cyclope ! Ces cyclopes, joyeux et colorés, sont parfois des monstres, parfois des figures importantes de la pop culture ou simplement des personnages sortis de l\'imagination débordante du CyKlop. Rue piémontési, les cyclopes incarnent les artistes de monmartre et vous pourrez vous amuser à reconnaître Picasso, Modigliani, à completer , parmis tant d\'autre','images/cyclop.jpg','Rue Piémontési – 18e arr.','Abbesses - ligne 12'],
				['Monsieur BMX',48.8576813,2.3585563,'art','Monsieur BMX est un artiste urbain qui découpe des vélos en deux pour les fixer en haut des murs de nos villes. Ne soyez-donc pas surpris si au détours d\'une rue vous appercevez un vélo qui semble figé dans une course folle à travers Paris. Drôles et décalées ces œuvres ont été apperçues pour la première fois à Montpellier, ville d\'origine de l\'artiste. Il n\'aura pas fallu longtemps pour qu\'il envahissent la capitale alors pensez à lever la tête lors de vos balades. Dernièrement, l\'artiste a repris ce principe de détournement d\'objet et a imaginé une œuvre sociale. En effet c\'est à présent des moitiés de caddie qui sont incrustées à Montpellier et remplies de denrées alimentaires « pour ceux qui en ont besoin ». On aura peut-être l\'occasion d\'en découvrir bientôt dans les ruelles parisiennes...','images/bmx.jpg','Au croisement de la rue Elzévir et de la rue des Franc-bourgeois – 4e arr.','Saint-Paul - ligne 1'],
				...
				['Première salle de basket d\'Europe, au foyer de Trévise',48.8734291,2.3452782,'histoire','Ce foyer pour jeunes gens, construit en 1893, abrite au sous-sol le gymnase où a été disputé le tout premier match de basket-ball en France et en Europe. Ce sport a été inventé deux ans auparavant par James Naismith, professeur au collège de Springfield dans le Massachusetts. Le gymnase est monté de façon identique à celui du collège de Springfield où un an plus tôt s\'était joué le premier match de basket-ball en public. Grâce à des fond américains tout le nécessaire fut acheminé par bateau à travers l\'atlantique. À l\'occasion des 150 des YMCA une plaque commémorative à été installée. L\'immeuble, dessiné par l\'architecte Bernard, disciple de Gustave Eiffel, abritait également la première piscine privée de Paris, une salle de spectacle et même un bowling. Ces derniers ont été fermé en 1965 car leur entretien et les nouvelles normes restrictives nécessitaient des dépenses trop importantes.','images/basket.jpg','14 rue de Trévise - 9e arr.','Grands Boulevards - ligne 8 et 9'],
				['Le mur des "Je t\'aime"',48.8848367,2.3363599,'art','Quel meilleur endroit que le jardin romantique du square Jehan Rictus à Monmartre pourrait acceuillir un monument à l\'amour ? À l\'heure où de trop nombreux murs sont érigés pour nous éloigner les uns des autres, le mur des « je t\'aime », œuvre de Frédéric Baron et Claire Kito est devenus un lieu de rendez-vous pour les amoureux du monde entier. Venez flâner dans un des lieux les plus romantiques de Paris et apprendre à dire "je t\'aime" dans toutes les langues...','images/mur.jpg','square Jehan Rictus, Place des Abbesses - 18e arr.','Abbesses - ligne 12'],
				['Cité Véron',48.8843544,2.3297962,'promenade','La Cité Véron est l\'une des rues les plus pittoresques du 18ème arrondissement mais elle est surtout fameuse car plusieurs poètes et écrivains du XXe siècle y habitèrent. En 1953, Boris Vian s\'installa au 3ème étage du n°6 bis avec Ursula Kubler, une danseuse de Ballet. En 1954, Jacques Prévert emménage lui aussi au n°6 bis et le théâtre ouvert, très dynamique est installé au n°4. Alors si votre chemin vous mène au pied de monmartre, ne manquez pas cette merveilleuse impasse !','images/veron.jpg','96 Boulevard de Clichy - 18e arr.','Blanche - ligne 2'],
				...
				['Le visage de Gregos',48.8574394,2.3364337,'art','L\'artiste Gregos a pris l\'habitude de coller une réplique exacte de son visage, souriant, tirant la langue ou mimant un baiser un peu partout dans Paris. Noirs ou multicolores ils sont souvent accompagné d\'une phrase écrite comme un message adressé aux passants. On retrouve ces visages figés dans les rues de Lille ou Marseille, et sans cesse de nouveaux dans les quartiers de Montmartre, Saint Michel, des Abbesses, Saint-Germain, Bastille, les Halles...','images/gregos.jpg','6 rue de Seine - 6e arr.','Saint Germain des Prés ou Mabillon - ligne 4 10'],
